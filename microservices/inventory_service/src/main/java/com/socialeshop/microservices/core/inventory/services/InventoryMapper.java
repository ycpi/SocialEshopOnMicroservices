...
public interface InventoryMapper {
    Inventory entityToDto(InventoryEntity entity);
    InventoryEntity dtoToEntity(Inventory Dto);
    List<Inventory> entityListToDtoList(List<InventoryEntity> inventoryEntities);
}
